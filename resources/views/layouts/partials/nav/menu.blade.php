<ul class="mt-6">
    ...
    @role('admin')
        ...
        <x-group-menu-item routePath="categories*" title="{{ __('Categories') }}"
    ...
    {{-- Products --}}
    @showProduct
        <x-group-menu-item routePath="product/*" title="{{ __('Products') }}"
    ...
    <x-group-menu-item routePath="subscription*" title="{{ __('Subscription') }}"
